...
<body>
    ...
    <form id="uploadForm" method="post" enctype="multipart/form-data">
        ...
        <label for="date_birth">Дата рождения</label><input type="date" name="date_birth" id="date_birth" placeholder=""
            min="1900-01-01" required>
        <label for="place_birth">Место рождения</label><input type="text" name="place_birth" id="address-input" autocomplete="off"
            placeholder="" required><div id="suggestions" class="suggestions-box"></div>
        ...
        <label for="address-input">Адрес по месту регистрации <br>(индекс, область, район, город, село, деревня, улица,
            дом, корпус, квартира)</label>
        <input type="text" id="address-input" name="off_address" autocomplete="off" required><div id="suggestions" class="suggestions-box"></div>
        <label for="address-input">Адрес фактический (если отличается)</label><input type="text" id="address-input"
            name="fact_address" autocomplete="off"><div id="suggestions" class="suggestions-box"></div>
                ...
                <tbody id="dynamic_2">
                    <tr>
                        <td><input type="date" id="date_start_work" name="date_start_work" min="1900-01-01"
                                class="input_table"></td>
                        <td><input type="date" id="date_end_work" name="date_end_work" min="1900-01-01"
                                class="input_table">
                        </td>
                        ...
                        <td><input type="text" id="address-input" name="work_place" class="input_table" autocomplete="off">
                        <div id="suggestions-container" class="suggestions-box"></div></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <label>Ваши близкие родственники (отец, мать, братья, сестры, дети, а также муж (жена), в том числе
            бывшие)</label>
        <div class="d_table">
            <table border="1">
                <thead>
                ...
                <tbody id="dynamic_3">
                    <tr>
                        ...
                        <td><input type="text" name="full_name_relative" class="input_table"></form></td>
                        <td><input type="date" id="date_birth_relative" name="date_birth_relative" min="1900-01-01"
                                class="input_table"></td>
                        <td><input type="text" id="address-input" name="place_birth_relative" class="input_table"></td>
                        <div id="suggestions-container" class="suggestions-box"></div>
                        <td><input type="text" id="address-input" name="place_work" class="input_table"></td>
                        <div id="suggestions-container" class="suggestions-box"></div>
                        <td><input type="text" name="job" class="input_table"></td>
                        <td><input type="text" id="address-input" name="residential_address" class="input_table" autocomplete="off"></td>
                        <div id="suggestions-container" class="suggestions-box"></div>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="d_table">
            <table border="1">
                ...
                <tbody id="dynamic_4">
                    <tr>
                        <td><input type="text" name="full_name_commercial_structures_founder"
                                class="input_table"></label>
                        </td>
                        <td><input type="text" id="address-input" name="address_commercial_structures_founder" class="input_table" autocomplete="off">
                        <div id="suggestions-container" class="suggestions-box"></div></td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="d_table">
            <table border="1">
                ...
                <tbody id="dynamic_5">
                    <tr>
                        <td><input type="text" name="full_name_organization_stock_owner" class="input_table">
                        </td>
                        <td><input type="text" id="address-input" name="address_organization_stock_owner" class="input_table" autocomplete="off">
                        <div id="suggestions-container" class="suggestions-box"></div></td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="d_table">
            <table border="1">
                ...
                <tbody id="dynamic_6">
                    <tr>
                        <td><input type="text" name="full_name_organization_affiliated_person"
                                class="input_table"></label>
                        </td>
                        <td><input type="text" id="address-input" name="address_organization_affiliated_person" class="input_table" autocomplete="off">
                        <div id="suggestions-container" class="suggestions-box"></div></td>
                    </tr>
                </tbody>
            </table>
